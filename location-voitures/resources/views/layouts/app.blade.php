...
<head>
    ...
    <style>
        ...
        .legacy-logo { height: 44px; width: auto; }
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ $brandLogo }}" alt="Bouhila Car" class="legacy-logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navClient">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item"><a class="nav-link" href="{{ route('cars.index') }}">Vehicules</a></li>
                @auth('web')
                    ...
                    <li class="nav-item">
                        <form method="POST" action="{{ route('logout') }}" class="d-inline">@csrf
                            <button type="submit" class="btn nav-link" style="background:none;border:none;">Deconnexion</button>
                        </form>
                    </li>
                @else
...
<footer class="footer"><div class="container text-center">&copy; 2026 Bouhila Car</div></footer>
